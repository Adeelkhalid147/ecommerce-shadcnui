...
const BestSellingCard = ({ src, title, description, price,category,slug,discount, }: abc) => {
  return (
    <div>
      <div className="max-w-[350px] h-[30rem] p-4 mx-auto shadow-md rounded-xl relative group">
       ...
       <Link href={`/${category}/${slug}`}>
        ...
        {/* button div */}
        <div className="mt-2">
          <Button className="group bg-myblackhead hover:bg-transparent text-mywhite hover:text-myblackhead scroll-m-20 text-xs font-semibold tracking-tight rounded-xl absolute botton-2 right-2">
